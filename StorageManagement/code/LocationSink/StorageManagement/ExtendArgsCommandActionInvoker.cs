...
namespace wpfSimulation
{
    ...
    public class ExtendArgsCommandActionInvoker: TriggerAction<DependencyObject>
    {

            private string commandName;
            public static readonly DependencyProperty CommandProperty = DependencyProperty.Register("Command", typeof(ICommand), typeof(ExtendArgsCommandActionInvoker), null);
            public static readonly DependencyProperty CommandParameterProperty = DependencyProperty.Register("CommandParameter", typeof(object), typeof(ExtendArgsCommandActionInvoker), null);
            /// <summary>
            /// 获得或设置此操作应调用的命令的名称。
            /// </summary>
            ...
            public ICommand Command
            {
                get
                {
                    return (ICommand)base.GetValue(ExtendArgsCommandActionInvoker.CommandProperty);
                }
                set
                {
                    base.SetValue(ExtendArgsCommandActionInvoker.CommandProperty, value);
                }
            }
            /// <summary>
            /// 获得或设置命令参数。这是依赖属性。
            ...
            public object CommandParameter
            {
                get
                {
                    return base.GetValue(ExtendArgsCommandActionInvoker.CommandParameterProperty);
                }
                set
                {
                    base.SetValue(ExtendArgsCommandActionInvoker.CommandParameterProperty, value);
                }
            }
            /// <summary>
            /// 调用操作。
