...
namespace wpfSimulation
{
    ...
    public partial class App : Application
    {
        ...
        {
            //copy from others
            Application.Current.StartupUri = new Uri("Views/MapEditView.xaml", UriKind.Relative);
            //UI线程未捕获异常处理事件（UI主线程）
        ...
        private void App_DispatcherUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e)
        {
            ...
            MessageBox.Show(msg, "UI UnCatched Exception");
        ...
        private void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            {
                string msg = String.Format("{0}\n\n{1}", ex.Message, ex.StackTrace);//异常信息 和 调用堆栈信息
                MessageBox.Show(msg, "UnCatched Exception");
            }
        }
        ...
        private void TaskScheduler_UnobservedTaskException(object sender, UnobservedTaskExceptionEventArgs e)
        {
            ...
            MessageBox.Show(msg, "Multi Task UnCatched Exception");
        }
